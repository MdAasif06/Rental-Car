       ...
       border-borderColor border-b">
        <div>
          ...
          <div className="flex items-center gap-3 mt-6">
            <a href="#"><img src={assets.facebook_logo} className="w-5" alt="logo" /></a>
            <a href="#"><img src={assets.instagram_logo} className="w-5" alt="logo" /></a>
            <a href="#"><img src={assets.twitter_logo} className="w-5" alt="logo" /></a>
            <a href="#"><img src={assets.gmail_logo} className="w-5" alt="logo" /></a>
          </div>
        </div>
